...
final class SettingsStore: @unchecked Sendable {
  ...
  // ── Log Server ──
  /// Host/IP for live log streaming (used by C++ core)
  var logServerHost: String {
    didSet { iPSX2Bridge.setINIString("LogServer", key: "Host", value: logServerHost) }
  }
  /// Port for live log streaming (used by C++ core)
  var logServerPort: Int {
    didSet { iPSX2Bridge.setINIInt("LogServer", key: "Port", value: Int32(logServerPort)) }
  }
  /// Whether to stream logs to the remote server
  var logServerEnabled: Bool {
    didSet { iPSX2Bridge.setINIBool("LogServer", key: "Enabled", value: logServerEnabled) }
  }
  /// Whether to include timestamps in logs
  var logTimestamps: Bool {
    didSet { iPSX2Bridge.setINIBool("LogServer", key: "LogTimestamps", value: logTimestamps) }
  }
  ...
  var iopRecompiler: Bool {
    didSet {
      iPSX2Bridge.setINIBool("EmuCore/CPU/Recompiler", key: "EnableIOP", value: iopRecompiler)
    }
  }
  var vu0Recompiler: Bool {
    didSet {
      iPSX2Bridge.setINIBool("EmuCore/CPU/Recompiler", key: "EnableVU0", value: vu0Recompiler)
    }
  }
  var vu1Recompiler: Bool {
    didSet {
      iPSX2Bridge.setINIBool("EmuCore/CPU/Recompiler", key: "EnableVU1", value: vu1Recompiler)
    }
  }
  var fastBoot: Bool {
  ...
  var fastmem: Bool {
    didSet {
      iPSX2Bridge.setINIBool("EmuCore/CPU/Recompiler", key: "EnableFastmem", value: fastmem)
    }
  }
  ...
  var eeCycleRate: Int {
    didSet {
      iPSX2Bridge.setINIInt("EmuCore/Speedhacks", key: "EECycleRate", value: Int32(eeCycleRate))
    }
  }
  var vu1Instant: Bool {
  ...
  var mtvu: Bool {
    didSet { iPSX2Bridge.setINIBool("EmuCore/Speedhacks", key: "vuThread", value: mtvu) }
  }
  ...
  var mipmap: Bool {
    didSet { iPSX2Bridge.setINIBool("EmuCore/GS", key: "mipmap", value: mipmap) }
  }
  var upscaleMultiplier: Float {
    didSet {
      iPSX2Bridge.setINIFloat("EmuCore/GS", key: "upscale_multiplier", value: upscaleMultiplier)
    }
  }
  var vsyncQueueSize: Int {
    didSet {
      iPSX2Bridge.setINIInt("EmuCore/GS", key: "VsyncQueueSize", value: Int32(vsyncQueueSize))
    }
  }
  ...
  var interlaceMode: Int {
    didSet {
      iPSX2Bridge.setINIInt("EmuCore/GS", key: "deinterlace_mode", value: Int32(interlaceMode))
    }
  }
  var aspectRatio: Int {
  ...
  var blendingAccuracy: Int {
    didSet {
      iPSX2Bridge.setINIInt(
        "EmuCore/GS", key: "accurate_blending_unit", value: Int32(blendingAccuracy))
    }
  }
  var dithering: Int {
  ...
  var osdShowResolution: Bool {
    didSet {
      iPSX2Bridge.setINIBool("EmuCore/GS", key: "OsdShowResolution", value: osdShowResolution)
    }
  }
  var osdShowFrameTimes: Bool {
    didSet {
      iPSX2Bridge.setINIBool("EmuCore/GS", key: "OsdShowFrameTimes", value: osdShowFrameTimes)
    }
  }
  ...
  var invertVirtualLeftStickY: Bool {
    didSet {
      iPSX2Bridge.setINIBool(
        "iPSX2/UI", key: "InvertVirtualLeftStickY", value: invertVirtualLeftStickY)
    }
  }
  var invertVirtualRightStickY: Bool {
    didSet {
      iPSX2Bridge.setINIBool(
        "iPSX2/UI", key: "InvertVirtualRightStickY", value: invertVirtualRightStickY)
    }
  }

  // ── Debug ──
  var traceExecution: Bool {
    didSet { iPSX2Bridge.setINIBool("EmuCore/CPU", key: "iPSX2_TRACE_EXEC", value: traceExecution) }
  }

  // ── Init from INI ──
  private init() {
    // Log Server
    logServerHost = iPSX2Bridge.getINIString("LogServer", key: "Host", defaultValue: "127.0.0.1")
    logServerPort = Int(iPSX2Bridge.getINIInt("LogServer", key: "Port", defaultValue: 5050))
    logServerEnabled = iPSX2Bridge.getINIBool("LogServer", key: "Enabled", defaultValue: false)
    logTimestamps = iPSX2Bridge.getINIBool("LogServer", key: "LogTimestamps", defaultValue: true)
    // CPU
    eeCoreType = Int(iPSX2Bridge.getINIInt("EmuCore/CPU", key: "CoreType", defaultValue: 0))
    iopRecompiler = iPSX2Bridge.getINIBool(
      "EmuCore/CPU/Recompiler", key: "EnableIOP", defaultValue: true)
    vu0Recompiler = iPSX2Bridge.getINIBool(
      "EmuCore/CPU/Recompiler", key: "EnableVU0", defaultValue: true)
    vu1Recompiler = iPSX2Bridge.getINIBool(
      "EmuCore/CPU/Recompiler", key: "EnableVU1", defaultValue: true)
    fastBoot = iPSX2Bridge.getINIBool("GameISO", key: "FastBoot", defaultValue: false)
    fastmem = iPSX2Bridge.getINIBool(
      "EmuCore/CPU/Recompiler", key: "EnableFastmem", defaultValue: true)
    // Boot
    fastCDVD = iPSX2Bridge.getINIBool("EmuCore/Speedhacks", key: "fastCDVD", defaultValue: false)
    // Advanced Speedhacks
    eeCycleRate = Int(
      iPSX2Bridge.getINIInt("EmuCore/Speedhacks", key: "EECycleRate", defaultValue: 0))
    ...
    mtvu = iPSX2Bridge.getINIBool("EmuCore/Speedhacks", key: "vuThread", defaultValue: true)
    // Graphics
    renderer = Int(iPSX2Bridge.getINIInt("EmuCore/GS", key: "Renderer", defaultValue: 17))
    mipmap = iPSX2Bridge.getINIBool("EmuCore/GS", key: "mipmap", defaultValue: true)
    upscaleMultiplier = iPSX2Bridge.getINIFloat(
      "EmuCore/GS", key: "upscale_multiplier", defaultValue: 1.0)
    vsyncQueueSize = Int(
      iPSX2Bridge.getINIInt("EmuCore/GS", key: "VsyncQueueSize", defaultValue: 8))
    ...
    interlaceMode = Int(
      iPSX2Bridge.getINIInt("EmuCore/GS", key: "deinterlace_mode", defaultValue: 7))
    aspectRatio = Int(iPSX2Bridge.getINIInt("EmuCore/GS", key: "AspectRatio", defaultValue: 0))
    blendingAccuracy = Int(
      iPSX2Bridge.getINIInt("EmuCore/GS", key: "accurate_blending_unit", defaultValue: 1))
    dithering = Int(iPSX2Bridge.getINIInt("EmuCore/GS", key: "dithering_ps2", defaultValue: 2))
    // OSD
    osdPreset =
      OsdPreset(rawValue: Int(iPSX2Bridge.getINIInt("iPSX2/UI", key: "OsdPreset", defaultValue: 0)))
      ?? .off
    ...
    osdShowResolution = iPSX2Bridge.getINIBool(
      "EmuCore/GS", key: "OsdShowResolution", defaultValue: false)
    osdShowFrameTimes = iPSX2Bridge.getINIBool(
      "EmuCore/GS", key: "OsdShowFrameTimes", defaultValue: false)
    // UI
    ...
    invertVirtualLeftStickY = iPSX2Bridge.getINIBool(
      "iPSX2/UI", key: "InvertVirtualLeftStickY", defaultValue: false)
    invertVirtualRightStickY = iPSX2Bridge.getINIBool(
      "iPSX2/UI", key: "InvertVirtualRightStickY", defaultValue: false)
    // Debug
    traceExecution = iPSX2Bridge.getINIBool(
      "EmuCore/CPU", key: "iPSX2_TRACE_EXEC", defaultValue: false)
    // Apply OSD preset
