...
private let licenses: [LicenseEntry] = [
  ...
  LicenseEntry(
    name: "pontos2024/PCSX2_ARM64", license: "GPL v3", copyright: "ARM64 recompiler port"),
  ...
  LicenseEntry(
    name: "libzip", license: "BSD 3-Clause", copyright: "© Dieter Baron, Thomas Klausner"),
  LicenseEntry(
    name: "FreeType", license: "FreeType License / GPL v2", copyright: "© The FreeType Project"),
  ...
  LicenseEntry(
    name: "glslang", license: "BSD 3-Clause / Apache 2.0", copyright: "© The Khronos Group Inc."),
