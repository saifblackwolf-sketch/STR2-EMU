...
struct GameScreenView: View {
  ...
  private func menuButton(isLandscape: Bool) -> some View {
    Menu {
      ...
      Divider()
      Button {
        _ = EmulatorBridge.shared.saveState()
      } label: {
        Label("Quick Save", systemImage: "arrow.down.doc")
      }
      Button {
        _ = EmulatorBridge.shared.loadState()
      } label: {
        Label("Quick Load", systemImage: "arrow.up.doc")
      }
      Divider()
      Button {
