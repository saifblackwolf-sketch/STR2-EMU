...
// Some non-MSVC tooling (including IntelliSense/clang) may not provide the
// project's expected architecture defines. Normalize them here so common code
// paths using _M_X86/_M_ARM64 resolve consistently.
#if !defined(_M_X86) && (defined(__x86_64__) || defined(__i386__) || defined(_M_IX86) || defined(_M_X64))
#define _M_X86 1
#endif
