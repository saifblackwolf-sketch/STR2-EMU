...
//#define EXTRA_DEBUG
	...
	if (DarwinMisc::iPSX2_TRACE_EXEC) {
		Console.WriteLn("@@TRACE_IOP@@ pc=%08x op=%-25s cyc=%u a0=%08x a1=%08x a2=%08x a3=%08x v0=%08x v1=%08x ra=%08x sp=%08x", 
			psxRegs.pc, disR3000AF(psxRegs.code, psxRegs.pc), psxRegs.cycle,
